...
public class BookingServiceTest {
    ...
    public void bookingTestServiceDaysCalculator() {
        ...
        Assertions.assertEquals(days, 8);
    }

    @Before
    public void setup() {
        LocalDate checkIn = LocalDate.parse("2021-01-02");
        LocalDate checkOut = LocalDate.parse("2021-01-10");

        BookingModel bookingModel = new BookingModel("1", "Joelma", checkIn, checkOut, 2);
